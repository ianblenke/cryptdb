...
static void query_1(exec_context& ctx) {
  physical_operator* op = new local_limit(100, 
    new local_order_by(
      ...
      new local_transform_op(
        {local_transform_op::trfm_desc(2), local_transform_op::trfm_desc(3), local_transform_op::trfm_desc(4), local_transform_op::trfm_desc(1), local_transform_op::trfm_desc(5), local_transform_op::trfm_desc(6), local_transform_op::trfm_desc(7), local_transform_op::trfm_desc(8), },
        new local_decrypt_op(
          {1, 2, 3, 4, 5, 6, 7, 8},
          new local_filter_op(
            new eq_node(new tuple_pos_node(0), new subselect_node(0, {new tuple_pos_node(1)})),
            new local_decrypt_op(
              {0},
              new remote_sql_op(new param_generator_id1, "select partsupp_enc_cryptdb_opt_with_det.ps_supplycost_DET, part_enc_cryptdb_opt_with_det.p_partkey_DET, supplier_enc_cryptdb_opt_with_det.s_acctbal_DET, supplier_enc_cryptdb_opt_with_det.s_name_DET, nation_enc_cryptdb_opt_with_det.n_name_DET, part_enc_cryptdb_opt_with_det.p_mfgr_DET, supplier_enc_cryptdb_opt_with_det.s_address_DET, supplier_enc_cryptdb_opt_with_det.s_phone_DET, supplier_enc_cryptdb_opt_with_det.s_comment_DET from part_enc_cryptdb_opt_with_det, supplier_enc_cryptdb_opt_with_det, partsupp_enc_cryptdb_opt_with_det, nation_enc_cryptdb_opt_with_det, region_enc_cryptdb_opt_with_det where (((((((part_enc_cryptdb_opt_with_det.p_partkey_DET) = (partsupp_enc_cryptdb_opt_with_det.ps_partkey_DET)) and ((supplier_enc_cryptdb_opt_with_det.s_suppkey_DET) = (partsupp_enc_cryptdb_opt_with_det.ps_suppkey_DET))) and ((part_enc_cryptdb_opt_with_det.p_size_DET) = (:0))) and (searchSWP(:1, :2, part_enc_cryptdb_opt_with_det.p_type_SWP))) and ((supplier_enc_cryptdb_opt_with_det.s_nationkey_DET) = (nation_enc_cryptdb_opt_with_det.n_nationkey_DET))) and ((nation_enc_cryptdb_opt_with_det.n_regionkey_DET) = (region_enc_cryptdb_opt_with_det.r_regionkey_DET))) and ((region_enc_cryptdb_opt_with_det.r_name_DET) = (:3))", {db_column_desc(db_elem::TYPE_DECIMAL_15_2, 15, oDET, SECLEVEL::DET, 3, false), db_column_desc(db_elem::TYPE_INT, 4, oDET, SECLEVEL::DETJOIN, 0, false), db_column_desc(db_elem::TYPE_DECIMAL_15_2, 15, oDET, SECLEVEL::DET, 5, false), db_column_desc(db_elem::TYPE_STRING, 25, oDET, SECLEVEL::DET, 1, false), db_column_desc(db_elem::TYPE_STRING, 25, oDET, SECLEVEL::DET, 1, false), db_column_desc(db_elem::TYPE_STRING, 25, oDET, SECLEVEL::DET, 2, false), db_column_desc(db_elem::TYPE_STRING, 40, oDET, SECLEVEL::DET, 2, false), db_column_desc(db_elem::TYPE_STRING, 15, oDET, SECLEVEL::DET, 4, false), db_column_desc(db_elem::TYPE_STRING, 101, oDET, SECLEVEL::DET, 6, false)}, {}, util::map_from_pair_vec<std::string, physical_operator*>({})))
            ,{
              new local_transform_op(
    ...
    new local_transform_op(
      ...
      new local_decrypt_op(
        ...
        new remote_sql_op(new param_generator_id24, "select custsale.cntrycode, count(*) as numcust, agg_hash(:0, '/space/stephentu/data/tpch_1_00/customer_enc/row_pack/acctbal', 256, 12, 't', custsale.abal) from ( select customer_enc_cryptdb_opt_with_det.c_phone_prefix_DET as cntrycode, customer_enc_cryptdb_opt_with_det.row_id as abal from customer_enc_cryptdb_opt_with_det where ((customer_enc_cryptdb_opt_with_det.c_phone_prefix_DET in ( :1, :2, :3, :4, :5, :6, :7 )) and ((customer_enc_cryptdb_opt_with_det.c_acctbal_OPE) > (:_subselect$0))) and (not ( exists ( (select 1 from orders_enc_cryptdb_opt_with_det where (orders_enc_cryptdb_opt_with_det.o_custkey_DET) = (customer_enc_cryptdb_opt_with_det.c_custkey_DET)) ) )) ) as custsale group by custsale.cntrycode", {db_column_desc(db_elem::TYPE_STRING, 15, oDET, SECLEVEL::DET, 4, false), db_column_desc(db_elem::TYPE_INT, 4, oNONE, SECLEVEL::PLAIN, 0, false), db_column_desc(db_elem::TYPE_STRING, 2147483647, oAGG, SECLEVEL::SEMANTIC_AGG, 0, false)}, {}, util::map_from_pair_vec<std::string, physical_operator*>({std::pair<std::string, physical_operator*>("_subselect$0", new local_encrypt_op({std::pair<size_t, db_column_desc>(0, db_column_desc(db_elem::TYPE_DECIMAL_15_2, 15, oOPE, SECLEVEL::OPE, 0, false))}, new local_transform_op(
          ...
          new local_decrypt_op(
            {0},
            new remote_sql_op(new param_generator_id23, "select agg_hash(:0, '/space/stephentu/data/tpch_1_00/customer_enc/row_pack/acctbal', 256, 12, 't', customer_enc_cryptdb_opt_with_det.row_id), count(*) from customer_enc_cryptdb_opt_with_det where ((customer_enc_cryptdb_opt_with_det.c_acctbal_OPE) > (:1)) and (customer_enc_cryptdb_opt_with_det.c_phone_prefix_DET in ( :2, :3, :4, :5, :6, :7, :8 ))", {db_column_desc(db_elem::TYPE_STRING, 2147483647, oAGG, SECLEVEL::SEMANTIC_AGG, 0, false), db_column_desc(db_elem::TYPE_INT, 4, oNONE, SECLEVEL::PLAIN, 0, false)}, {}, util::map_from_pair_vec<std::string, physical_operator*>({})))
        )
        ))})))
    )
  )
