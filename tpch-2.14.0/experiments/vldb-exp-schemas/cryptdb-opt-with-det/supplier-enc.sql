create table supplier_enc_cryptdb_opt_with_det (
...
-- INSERT INTO supplier_enc_cryptdb_opt_with_det
-- SELECT 
--   s_suppkey_DET,
--   s_name_DET,
--   s_name_OPE,
...
-- ALTER TABLE supplier_enc_cryptdb_opt_with_det ADD PRIMARY KEY (s_suppkey_DET);
