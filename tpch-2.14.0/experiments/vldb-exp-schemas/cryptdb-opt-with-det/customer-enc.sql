CREATE SEQUENCE customer_enc_cryptdb_opt_with_det_seq MINVALUE 0;
CREATE TABLE customer_enc_cryptdb_opt_with_det ( 
  ...
  row_id bigint not null DEFAULT nextval('customer_enc_cryptdb_opt_with_det_seq')
  --PRIMARY KEY (c_custkey_DET)
);

--INSERT INTO customer_enc_cryptdb_opt_with_det
--SELECT 
--  c_custkey_DET,
--  c_name_DET,
--  c_address_DET,
...
--ALTER TABLE customer_enc_cryptdb_opt_with_det ADD PRIMARY KEY (c_custkey_DET);
