create table nation_enc_cryptdb_opt_with_det (
...
--INSERT INTO nation_enc_cryptdb_opt_with_det
--SELECT 
--  n_nationkey_DET,
--  n_name_DET,
--  n_name_OPE,
...
--  n_comment_DET 
--FROM nation_enc;
--ALTER TABLE nation_enc_cryptdb_opt_with_det ADD PRIMARY KEY (n_nationkey_DET);
