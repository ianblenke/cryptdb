CREATE SEQUENCE lineitem_enc_cryptdb_opt_with_det_seq MINVALUE 0;
create table lineitem_enc_cryptdb_opt_with_det (
  ...
  row_id bigint NOT NULL DEFAULT nextval('lineitem_enc_cryptdb_opt_with_det_seq')

  -- PRIMARY KEY (l_orderkey_DET, l_linenumber_DET)

) ;

-- INSERT INTO lineitem_enc_cryptdb_opt_with_det 
-- SELECT
--   l_orderkey_DET,
--   l_partkey_DET,
--   l_suppkey_DET,
...
-- ALTER TABLE lineitem_enc_cryptdb_opt_with_det ADD PRIMARY KEY (l_orderkey_DET, l_linenumber_DET);
