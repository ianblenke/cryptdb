...
#define LINEITEM_ENC_NAME "lineitem_enc_orig_plus_col_packing"
#define CUSTOMER_ENC_NAME "customer_enc_orig_system"
#define PARTSUPP_ENC_NAME "partsupp_enc_orig_system"
#define ORDERS_ENC_NAME   "orders_enc_orig_system"
