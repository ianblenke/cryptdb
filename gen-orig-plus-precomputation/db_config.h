...
#define LINEITEM_ENC_NAME "lineitem_enc_orig_plus_precomputation"
#define CUSTOMER_ENC_NAME "customer_enc_orig_plus_precomputation"
#define PARTSUPP_ENC_NAME "partsupp_enc_orig_plus_precomputation"
